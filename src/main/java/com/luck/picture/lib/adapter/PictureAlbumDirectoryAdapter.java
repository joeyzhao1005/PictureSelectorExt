...
import com.kit.pictureselectorext.R;
import com.zhao.image.imageloader.RequestListener;
...
public class PictureAlbumDirectoryAdapter extends RecyclerView.Adapter<PictureAlbumDirectoryAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        if (mimeType == PictureMimeType.ofAudio()) {
            ...
            holder.first_image.setImageResource(R.drawable.ic_placeholder);
            ImageShower.getInstance().showFile(holder.first_image, imagePath, new RequestListener<Bitmap>() {
                @Override
